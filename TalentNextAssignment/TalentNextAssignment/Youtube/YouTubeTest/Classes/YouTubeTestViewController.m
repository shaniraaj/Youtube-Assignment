...
#define DEVELOPER_KEY @"YOURKEY!!!"
#define CLIENT_ID @"YOURCLIENTID!!!!!" // ID of your registered app at Google
...
- (void)viewDidLoad {
    ...
    [mTitleField setText: @"iPhone Upload Test"];
    [mDescriptionField setText: @"Sargon Rules!"];
    [mKeywordsField setText: @"sargon uri nieto ultimate screaming lessons"];
